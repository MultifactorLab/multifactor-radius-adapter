...
## Содержание
* [Что такое Что такое Multifactor radius adapter?](#что-такое-multifactor-radius-adapter?)
...
Информацию о настройке, запуске и дополнительные рекомендации смотрите в [документации](https://multifactor.ru/docs/radius-adapter/linux/).
