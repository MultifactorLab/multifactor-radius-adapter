...
public class LdapFirstFactorProcessor : IFirstFactorProcessor
{
        ...
        string password)
    {
        ...
        try
        {
            ...
            _ldapAdapter.CheckConnecion(request);
    ...
    private void Reject(RadiusPipelineContext context)
    {
        context.FirstFactorStatus = AuthenticationStatus.Reject;
    }

    private void Accept(RadiusPipelineContext context)
    {
        context.FirstFactorStatus = AuthenticationStatus.Accept;
    }


    private bool CheckLdapException(LdapException exception, out string reasonText)
    {
