...
public class RadiusFirstFactorProcessor : IFirstFactorProcessor
{
    ...
    public RadiusFirstFactorProcessor(IRadiusPacketService radiusPacketService, 
        IRadiusClientFactory radiusClientFactory, 
        ILogger<RadiusFirstFactorProcessor> logger)
    {
