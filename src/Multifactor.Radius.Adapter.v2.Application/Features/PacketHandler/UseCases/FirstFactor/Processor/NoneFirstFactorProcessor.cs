...
internal sealed class NoneFirstFactorProcessor : IFirstFactorProcessor
{
    ...
    public Task Execute(RadiusPipelineContext context)
    {
        ...
        _logger.LogInformation("Bypass first factor for user '{user:l}' due to '{ff:l}' variant of first factor.", 
            context.RequestPacket.UserName, context.ClientConfiguration.FirstFactorAuthenticationSource.ToString());
