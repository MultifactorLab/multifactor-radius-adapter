...
namespace Multifactor.Radius.Adapter.v2.Infrastructure.Configuration.Sections.LdapServer;
...
public class LdapServerConfiguration
{
    ...
    [ConfigurationKeyName("use-attributes-as-identity")]
    public string AttributesAsIdentity { get; init; }
}