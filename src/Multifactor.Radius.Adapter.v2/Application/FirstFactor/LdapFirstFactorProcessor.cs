...
public class LdapFirstFactorProcessor : IFirstFactorProcessor
{
    ...
    public Task ProcessFirstFactor(RadiusPipelineExecutionContext context)
    {
    ...
    private void Reject(RadiusPipelineExecutionContext context)
    {
        context.AuthenticationState.FirstFactorStatus = AuthenticationStatus.Reject;
    }

    private void Accept(RadiusPipelineExecutionContext context)
    {
    ...
    private void ProcessErrorReason(LdapErrorReasonInfo errorInfo, RadiusPipelineExecutionContext context, ILdapServerConfiguration ldapServerConfiguration)
    {
