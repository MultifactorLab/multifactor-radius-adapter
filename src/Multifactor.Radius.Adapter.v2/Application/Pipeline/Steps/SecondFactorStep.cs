...
public class SecondFactorStep : IRadiusPipelineStep
{
    ...
    private bool ShouldCallSecondFactor(RadiusPipelineExecutionContext context)
    {
    ...
    private bool ShouldBypassByRequest(RadiusPipelineExecutionContext context)
    {
        return context.RequestPacket.IsVendorAclRequest && context.FirstFactorAuthenticationSource == AuthenticationSource.Radius;
    }

    private bool ShouldBypassByGroups(RadiusPipelineExecutionContext context)
    {
    ...
    private bool ShouldCacheResponse(RadiusPipelineExecutionContext context)
    {
    ...
    private void ProcessApiResponse(RadiusPipelineExecutionContext context, MultifactorResponse apiResponse)
    {
