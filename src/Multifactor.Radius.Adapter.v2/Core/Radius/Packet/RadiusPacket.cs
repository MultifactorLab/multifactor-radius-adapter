...
public class RadiusPacket : IRadiusPacket
{
    ...
    public bool IsEapMessageChallenge =>
        Header.Code == PacketCode.AccessChallenge && AuthenticationType == AuthenticationType.EAP;
    ...
    public RadiusPacket(RadiusPacketHeader header, RadiusAuthenticator authenticator, RadiusAuthenticator? requestAuthenticator = null)
    {
