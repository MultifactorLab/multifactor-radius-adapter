...
public class RadiusNasIdentifierExtractor : INasIdentifierExtractor
{
    private const int NasIdentifierAttributeCode = 32;
    private const int MinimumPacketLength = 20;

    public bool TryExtract(byte[] packetBytes, out string nasIdentifier)
    {
        ...
        try
        {
            ...
            ushort packetLength = BitConverter.ToUInt16(new[] { packetBytes[3], packetBytes[2] }, 0);
