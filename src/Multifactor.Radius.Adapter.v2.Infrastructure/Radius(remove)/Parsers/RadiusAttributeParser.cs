...
using Multifactor.Radius.Adapter.v2.Infrastructure.Radius_remove_.Crypto;
using Multifactor.Radius.Adapter.v2.Infrastructure.Radius_remove_.Parsers.Models;

namespace Multifactor.Radius.Adapter.v2.Infrastructure.Radius_remove_.Parsers;
...
internal sealed class RadiusAttributeParser : IRadiusAttributeParser
{
        ...
        SharedSecret sharedSecret)
    {
        ...
        return content == null ? null 
            : new ParsedAttribute(vendorAttribute.Name, content);
    }
        ...
        SharedSecret sharedSecret)
    {
        switch (type)
        {
            ...
            case DictionaryAttribute.TypeString:
                //cause some NAS (like NPS) send binary within string attributes, check content before unpack to prevent data loss
