...
public class InvalidConfigurationException : Exception
{
    ...
    // public static InvalidConfigurationException For<TProp>(Expression<Func<AppConfig, TProp>> propertySelector, 
    ...
    // }
    //
    // private static string Property<TProp>(Expression<Func<AppConfig, TProp>> propertySelector)
    // {
    //     ArgumentNullException.ThrowIfNull(propertySelector);
    //
