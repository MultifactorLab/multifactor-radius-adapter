...
internal sealed class CreateAccessRequest : ICreateAccessRequest
{
    private const string ClientName = "multifactor-api";
    private const string Url = "access/requests/ra";
    private readonly JsonSerializerOptions _jsonOptions = new(JsonSerializerDefaults.Web);
    private readonly IHttpClientFactory _clientFactory;
    private readonly ILogger<ICreateAccessRequest> _logger;
    
    public CreateAccessRequest(
        IHttpClientFactory clientFactory, 
        ILogger<ICreateAccessRequest> logger)
    {
        _clientFactory = clientFactory;
        _logger = logger;
    }
    
    public async Task<AccessRequestResponse> Execute(AccessRequestDto dto, MultifactorAuthData authData, CancellationToken cancellationToken = default)
    {
