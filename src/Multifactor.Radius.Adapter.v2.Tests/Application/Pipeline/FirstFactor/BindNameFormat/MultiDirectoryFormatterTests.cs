...
{
    public class MultiDirectoryFormatterTests
    {
        private readonly MultiDirectoryFormatter _formatter;

        public MultiDirectoryFormatterTests()
        {
            _formatter = new MultiDirectoryFormatter();
        }

        [Fact]
        public void LdapImplementation_ShouldReturnMultiDirectory()
        {
            // Assert
            Assert.Equal(LdapImplementation.MultiDirectory, _formatter.LdapImplementation);
        }
