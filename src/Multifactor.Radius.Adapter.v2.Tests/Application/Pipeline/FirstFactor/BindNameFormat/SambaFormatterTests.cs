...
{
    public class SambaFormatterTests
    {
        private readonly SambaFormatter _formatter;

        public SambaFormatterTests()
        {
            _formatter = new SambaFormatter();
        }

        [Fact]
        public void LdapImplementation_ShouldReturnSamba()
        {
            // Assert
            Assert.Equal(LdapImplementation.Samba, _formatter.LdapImplementation);
        }
