...
{
    public class OpenLdapFormatterTests
    {
        private readonly OpenLdapFormatter _formatter;

        public OpenLdapFormatterTests()
        {
            _formatter = new OpenLdapFormatter();
        }

        [Fact]
        public void LdapImplementation_ShouldReturnOpenLDAP()
        {
            // Assert
            Assert.Equal(LdapImplementation.OpenLDAP, _formatter.LdapImplementation);
        }
